...
public class SimpleMovingAverageTest {
    ...
    public void getMovingAverage_test_period1() {
        ...
        Assert.assertEquals(simpleMovingAverage.getMovingAverage(), 3.0, 1e-8);
    }
    ...
    public void getMovingAverage_test_period3() {
        ...
        Assert.assertEquals(simpleMovingAverage.getMovingAverage(), -1, 0.00001);
        simpleMovingAverage.addValue(2.0);
        Assert.assertEquals(simpleMovingAverage.getMovingAverage(), -1, 0.00001);
        simpleMovingAverage.addValue(3.0);
        Assert.assertEquals(simpleMovingAverage.getMovingAverage(), 2, 0.00001);
        simpleMovingAverage.addValue(4.0);
        Assert.assertEquals(simpleMovingAverage.getMovingAverage(), 3, 0.00001);
        simpleMovingAverage.addValue(5.0);
        Assert.assertEquals(simpleMovingAverage.getMovingAverage(), 4, 0.00001);
    }
}
